...
print("t_min, t_min_-, t_min_+, depth, depth_-, depth_+, t0, t0_-, t0_+, ti, ti_-, ti_+, te, te_-, te_+, a, a_-, a_+, w1m, tom, tnt")
for night, initial_pos in enumerate(initial_poses):
    ...
    for i in range((num_parameters - 2) // 4):
        ...
        print(f"{best_fits[4 * i + 5]:.5f},{lower_uncertainties[4 * i + 5]:.5f},{upper_uncertainties[4 * i + 5]:.5f},1,0,0")
    # print()
